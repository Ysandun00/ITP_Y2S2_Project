...
<hr style = {{height:'100px'}}></hr>
        ...
        value={searchInput} style={{width:'500px', marginLeft:'250px'}} />
            ...
            <table className="table table-bordered" style={{width:'90%', alignItems:'center', margin:'auto',background:'#EBECF0' }}>
        ...
        <hr></hr>
        {/* <button class="yasitha" type="submit" >Next</button> */}

        <button type="submit" style={{backgroundColor: '#3fbbc0', marginLeft: '1300px',paddingLeft: '20px',paddingRight: '20px',}} onClick={()=>window.location.href="/Pview"}>Next</button>
